...
class EditProducto extends Component {
    ...
    componentDidMount() {
        ...
        this.props.dispatch(change('EditProductoForm', 'productoN', data.productoN));
        this.props.dispatch(change('EditProductoForm', 'cantidad', data.cantidad));
        this.props.dispatch(change('EditProductoForm', 'costo_unitario', data.costo_unitario));
        this.props.dispatch(change('EditProductoForm', 'costo_mayoreo', data.costo_mayoreo));
...
const EditProductoForm = reduxForm({
